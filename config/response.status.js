...
export const status = {
  ...
  // mission err
  MISSION_ALREADY_DOING_EXIST: { status: StatusCodes.BAD_REQUEST, isSuccess: false, code: "MISSION4001", message: "이미 미션을 진행하고 있거나 완료했습니다." },
  MISSION_ALREADY_DONE: { status: StatusCodes.BAD_REQUEST, isSuccess: false, code: "MISSION4002", message: "이미 미션을 진행 완료했습니다." },
};
